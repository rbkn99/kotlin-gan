...
class Generator(nn.Module):
    ...
    def forward(self, prev: Variable, parent: Variable, hidden: Variable):
        prev_emb = self.actions_embeddings(prev)
        parent_emb = self.rules_embeddings(parent)
    ...
    # def sample(self, num_samples, start_rule=0):
    #     """
    ...
    #     stacks = [[()] for _ in range(num_samples)]
    #
    #     if self.gpu:
